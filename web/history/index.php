...
try
{
 ...
 $statement = $db->prepare('INSERT INTO event(user_id, updated, act_date, title, description, organizaiton_id) VALUES(1, date(), :act_date, :title, :description, :organization_id)'); 
