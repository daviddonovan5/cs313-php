  ...
  <CENTER>
    ...
    <table style="width:100%">
      ...
      <tr>
        ...
        <td>$48.00<br>
        Quantity: <br><input id="Quantity2" type="number" name="widget2" min="0" max="20" value="<?php echo($_SESSION['quantity2']);?>"</td>
      </tr>
      <tr>
        ...
        <td>$25.00<br>
        Quantity: <br><input id="Quantity3" name="widget3" type="number" min="0" max="20" value="<?php echo($_SESSION['quantity3']);?>" </td>
      </tr>
      <tr>
        ...
        <td>$95.00<br>
        Quantity: <br><input id="Quantity4" name="widget4" type="number" min="0" max="20" value="<?php echo($_SESSION['quantity4'] );?>" </td>
      </tr></tr></table>
